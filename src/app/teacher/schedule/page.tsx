          ...
          <div className="grid grid-cols-8 gap-3.5">
            ...
            {weekDates.map((d) => {
              ...
              return (
                <div
                  key={d.key}
                  className="p-3.5 text-center rounded-2xl transition-all space-y-1 h-[92px] flex flex-col justify-center items-center z-10 bg-[#FAF2EC] border border-[#E8D4C5] shadow-xs"
                >
