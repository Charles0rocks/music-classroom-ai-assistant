            ...
            <div className="grid grid-cols-[96px_repeat(7,_minmax(0,_1fr))] gap-3.5 sticky top-0 z-30 bg-[#FAF7F2] py-1">
              ...
              {weekDates.map((d) => {
                ...
                return (
                  <div
                    key={d.key}
                    className="p-2 text-center rounded-2xl transition-all space-y-0.5 h-[56px] flex flex-col justify-center items-center bg-[#FAF2EC] border border-[#E8D4C5] shadow-xs"
                  >
            ...
            {TIME_BLOCKS.map((block) => {
              ...
              return (
                <div key={block.key} className="grid grid-cols-[96px_repeat(7,_minmax(0,_1fr))] gap-3.5 items-stretch">
                  ...
                  {/* 7 Day Cells for this Time Block */}
                  {weekDates.map((d) => {
